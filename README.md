...
- [ ] Prevent xss attacks -- there are some "todo" comments in the code that were supposed to remind me to rewrite a couple parts of the code that are vulnerable to cross-site scripting attacks. Then I forgot to check my reminders and uploaded the code here. So don't use this til the cross-site scripting vulnerabilities are fixed otherwise you will probably lose all your money.
